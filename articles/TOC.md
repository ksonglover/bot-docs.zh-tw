...
## [部署 Bot botbuilder-samples 存放庫](bot-builder-deploy-samples.md)
# 概念
...
#### [使用對話方塊提示蒐集使用者輸入](v4sdk/bot-builder-prompts.md)
...
#### [保存使用者資料](v4sdk/bot-builder-tutorial-persist-user-inputs.md)
...
### [為您的 Bot 實作自訂儲存體](v4sdk/bot-builder-custom-storage.md)
### [將遙測新增至 Bot](v4sdk/bot-builder-telemetry.md)
