...
<ol>
    <li><a href="/bot-framework/bot-builder-tutorial-authentication">在您的 Bot 中新增驗證</a></li>
</ol>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>REST</h3>
                        <p><a href="/Bot-Framework/rest-api/bot-framework-rest-connector-api-reference">REST API 參考</a></p>
                    </div>
                </div>
            </div>
        </div>
